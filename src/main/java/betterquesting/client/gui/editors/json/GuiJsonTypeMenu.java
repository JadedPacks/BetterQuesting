...
public class GuiJsonTypeMenu extends GuiScreenThemed implements IVolatileScreen {
	...
	public void initGui() {
		...
		GuiButtonThemed fluidButton = new GuiButtonThemed(4, this.width / 2 - 100, this.height / 2, 200, 20, I18n.format("betterquesting.btn.fluid"), true); // Fluid Editor
